...
<div class="container">
	...
	<!-- 댓글등록 -->
	<button id="addReplyBtn" type="button" class="btn btn-primary" data-toggle="modal" data-target="#replyForm"> 댓글등록 </button>
				...
				<div class="panel-body">
					<ul class="chat">
						<li data-rno='1'>
						  <div>
							<div class='header'>
								<strong class='primary-font'>작성자(신짱구)</strong>
								<small class='pull-right text-muted'>2022-06-22</small>
							</div>
							<p>댓글내용....</p>
						  </div>	
						</li>
